...
/**
 * Renders the Pokémon-style battle scene using images only.
 *
 * ── Required image files (place in the images/ folder next to src/) ───────
 *
 *  BACKGROUNDS (560 x 288 PNG):
 *    images/battleground.png          <- normal fight background
 *    images/boss_battleground.png     <- boss fight background
 *
 *  PLAYER SPRITES (~96 x 128 PNG, transparent background):
 *    images/player_idle.png           <- standing
 *    images/player_attack.png         <- mid-swing / attacking
 *    images/player_hurt.png           <- flinching / taking damage
 *
 *  ENEMY SPRITES (~96 x 128 PNG, transparent background):
 *    images/goblin_idle.png
 *    images/goblin_hurt.png
 *    images/skeleton_idle.png
 *    images/skeleton_hurt.png
 *    images/troll_idle.png
 *    images/troll_hurt.png
 *    images/witch_idle.png
 *    images/witch_hurt.png
 *
 *  If a file is missing, a placeholder coloured box is drawn instead
 *  so the game still runs while you add sprites one by one.
 * ──────────────────────────────────────────────────────────────────────────
 */
public class BattleScene extends JPanel {
    ...
    // ─── Player sprite ────────────────────────────────────────────────────
    private void drawPlayerSprite(Graphics2D g2, int W, int H) {
        /*
